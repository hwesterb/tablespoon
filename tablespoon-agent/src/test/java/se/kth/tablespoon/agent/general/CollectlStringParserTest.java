...
public class CollectlStringParserTest {
	...
	public void findTypeTest() {
		MetricSource et = CollectlStringParser.findType("DSK");
		assertEquals(MetricSource.DSK, et);
	}
	...
	public void threeMatchTest() {
		...
		assertEquals(MetricSource.CPU, els[0].getSource());
	}
	...
	public void handleHeadersTest() {
		...
		assertEquals(MetricSource.CPU, els[9].getSource());
